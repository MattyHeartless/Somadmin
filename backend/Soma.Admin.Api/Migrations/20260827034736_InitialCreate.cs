        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationStartsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ReservationEndsAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Events_OccupiedSlots", "[OccupiedSlots] >= 0 AND [OccupiedSlots] <= [Capacity]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrTokenHash = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_ClientProfiles_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessLogs_EventId_CreatedAt",
                table: "AccessLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_QrTokenHash",
                table: "Reservations",
                column: "QrTokenHash",
                unique: true);
        }
